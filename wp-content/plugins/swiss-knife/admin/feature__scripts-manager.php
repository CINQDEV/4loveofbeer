<?php
	...
	if(isset($_POST['save_scripts'])){
		...
		foreach($_POST['script_name'] as $script_name){
			$insert_array[] = "('".$_POST['script_name'][$i]."', '".$_POST['script_type'][$i]."', '".$_POST['script_location'][$i]."', '".$_POST['script_include_type'][$i]."', '".$_POST['script_file'][$i]."', '".$_POST['script_frontend_only'][$i]."')";
			$i++;
		}
		$insert_query = "INSERT INTO ".$swiss_knife_scripts." (script_name, script_type, script_location, script_include_type, script_file, script_frontend_only) VALUES ";
...
<svg display="none">
	...
	<symbol width="24" height="24" viewBox="0 0 24 24" id="copy-icon">
		<path d="M0 0h24v24H0z" fill="none"/>
		<path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>
	</symbol>

	<symbol width="24" height="24" viewBox="0 0 128 128" id="css-icon">
	...
	<symbol width="24" height="24" viewBox="0 0 128 128" id="js-icon">
