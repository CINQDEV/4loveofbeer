<form id="scripts-form" method="post" action="">
	<div class="scripts-rows">
		<?php 
			...
			$html = '';
			$all_scripts = $wpdb->get_results( "SELECT * FROM $swiss_knife_scripts" );
